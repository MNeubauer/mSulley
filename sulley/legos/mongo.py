from sulley.primitives import dword, qword, group
...
"""
    struct OP_UPDATE {
        ...
        cstring   fullCollectionName;   // "dbname.collectioname"
...
class OP_DELETE(MongoMsg):
    """This sulley lego represents an OP_DELETE MongoDB message"""
